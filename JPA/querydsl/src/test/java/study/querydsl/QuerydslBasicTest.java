...
public class QuerydslBasicTest {
    ...
    @Test
    public void startJPQLTest() throws Exception {
        // member1을 찾아라
...
//        QMember m = QMember.member;
    ...
    public void resultFetchTest() {
        ...
        Member fetchOne = queryFactory
                .selectFrom(member)
                .where(member.username.eq("member1")) // 단 건이 아니면 NonUniqueResultException
                .fetchOne();
...
//                .join(member.team, team)
     ...
     */
    @Test
    public void join_on_filtering_Test() throws Exception {
        List<Tuple> result = queryFactory
                .select(member, team)
                .from(member)
                .leftJoin(member.team, team)
     ...
     */
    @Test
    public void join_on_no_relation_Test() throws Exception {
        em.persist(new Member("teamA"));
        em.persist(new Member("teamB"));
        em.persist(new Member("teamC"));
    ...
    @Test
    public void orderByWithCaseTest() {
...
//                .where(usernameEq(usernameCond), ageEq(ageCond))
    ...
    public void bulkUpdateTest() throws Exception {
        ...
        // 2 member1 = 20 -> 2 DB 비회원
        // 3 member1 = 30 -> 3 DB member3
        // 4 member1 = 40 -> 4 DB member4
